...
import com.hazelcast.common.MyConstants;
...
public class FraudService {
	...
	public IMap<String, Airport> getAirportsMap() {
		return airportsMap;
	}

	public void setAirportsMap(IMap<String, Airport> airportsMap) {
    ...
    private void alert(User user, String airportCode) {
        ...
        if (results.size() == 2) {
            ...
            System.out.println("alert({}, {}), Collection.size()=={}"+" : "+
